...
/*because I couldn't get the geometric AA in the book working,
and everywhere I read online said this was included in gl/glew, 
this was the only workaround I could find.
The alternative would have been to tune on AA for points or lines,
which would not work either.

disregard just realized it was meant for lines.*/
...
void init(void)
{
   ...
   glHint (GL_LINE_SMOOTH_HINT, GL_DONT_CARE);
	...
	submenu1 = glutCreateMenu(selectFog);
	glutAddMenuEntry("On", 1);
	glutAddMenuEntry("Off", 2);
	submenu2 = glutCreateMenu(selectAliasing);
	glutAddMenuEntry("On", 1);
	glutAddMenuEntry("Off", 2);
	glutCreateMenu(selectFont);
	glutAddSubMenu("Fog", submenu1);
	glutAddSubMenu("Anti-Aliasing", submenu2);
...
void display(void)
{
	...
	glScalef(0.91428571428571,0.91428571428571,0.91428571428571);
	glutWireSphere(5,15,15);
	//Moon.
